function EditorCtrl(window, document, elementId, userId) {
  ...
  function addColor(parent, getColor, title, onChange) {
    var onClick = function () {
      var color = getColor();
      showColorPicker(parent, color, title, onChange);
    };
    var color = getColor();
    return addColorButton(parent, color, 5, onClick);
  }
  ...
  function addFontFile(italic, bold, family, file) {
    var key = makeFontKey(italic, bold, family);
    fontFiles[key] = file;
  }
  ...
  function addFree(evt, type, subtype) {
    ...
    globals.editor.insertFreeItem(dia.x, dia.y, type, subtype);
    globals.view.redraw();
  }
  ...
  function addFreeButtons() {
    var rect = new ButtonInfo(
      ...
      "BUT_FREE_RECTANGLE",
      function (e) {
        addFree(e, "f_rectangle");
      },
    );
    var label = new ButtonInfo("f_label", "text.png", "BUT_TEXT", function (e) {
      addFree(e, "f_label");
    });
    var line = new ButtonInfo("f_line", "line.png", "BUT_LINE", function (e) {
      addFree(e, "f_line");
    });
    var arrow = new ButtonInfo("f_arrow", "arrow.png", "BUT_ARROW", function (
      e,
    ) {
      addFree(e, "f_arrow");
    });
    var begin = new ButtonInfo(
      "f_begin",
      "f_begin.png",
      "BUT_FBEGIN",
      function (e) {
    ...
    var left = new ButtonInfo(
      "f_ptr_left",
      "ptr-left.png",
      "BUT_PTR_LEFT",
      function (e) {
        addFree(e, "f_ptr_left");
      },
    );
    var right = new ButtonInfo(
      "f_ptr_right",
      "ptr-right.png",
      "BUT_PTR_RIGHT",
      function (e) {
        addFree(e, "f_ptr_right");
      },
    );
    var insertion = new ButtonInfo(
      "f_insertion",
      "f_insertion.png",
      "BUT_INSERTION",
      function (e) {
        addFree(e, "f_insertion");
      },
    );
    var shelf = new ButtonInfo("f_shelf", "f_shelf.png", "BUT_SHELF", function (
      e,
    ) {
      addFree(e, "f_shelf");
    });
    var callout = new ButtonInfo(
      "f_callout",
      "callout.png",
      "BUT_CALLOUT",
      function (e) {
    ...
    var vscroll = new ButtonInfo(
      "f_ui_vscroll",
      "f_ui_vscroll.png",
      "BUT_UI_VSCROLL",
      function (e) {
        addFree(e, "f_more", "f_ui_vscroll");
      },
    );
    var hscroll = new ButtonInfo(
      "f_ui_hscroll",
      "f_ui_hscroll.png",
      "BUT_UI_HSCROLL",
      function (e) {
        addFree(e, "f_more", "f_ui_hscroll");
      },
    );
    ...
    var cross = new ButtonInfo(
      "f_ui_cross",
      "f_cross.png",
      "BUT_UI_CROSS",
      function (e) {
        addFree(e, "f_more", "f_ui_cross");
      },
    );
    var check = new ButtonInfo(
      "f_ui_check",
      "check.png",
      "BUT_UI_CHECK",
      function (e) {
        addFree(e, "f_more", "f_ui_check");
      },
    );
    var menu = new ButtonInfo(
      "f_ui_menu",
      "f_menu.png",
      "BUT_UI_MENU",
      function (e) {
        addFree(e, "f_more", "f_ui_menu");
      },
    );
    var combo = new ButtonInfo(
      "f_ui_combo",
      "f_combo.png",
      "BUT_UI_COMBO",
      function (e) {
        addFree(e, "f_more", "f_ui_combo");
      },
    );
    var left1 = new ButtonInfo(
      "f_ui_left",
      "left-angle.png",
      "BUT_UI_LEFT",
      function (e) {
        addFree(e, "f_more", "f_ui_left");
      },
    );
    var right1 = new ButtonInfo(
      "f_ui_right",
      "right-angle.png",
      "BUT_UI_RIGHT",
      function (e) {
        addFree(e, "f_more", "f_ui_right");
      },
    );
    var up = new ButtonInfo("f_ui_up", "up-angle.png", "BUT_UI_UP", function (
      e,
    ) {
      addFree(e, "f_more", "f_ui_up");
    });
    var down = new ButtonInfo(
      "f_ui_down",
      "down-angle.png",
      "BUT_UI_DOWN",
      function (e) {
        addFree(e, "f_more", "f_ui_down");
      },
    );
    var left2 = new ButtonInfo(
      "f_ui_left2",
      "left-angle2.png",
      "BUT_UI_LEFT2",
      function (e) {
        addFree(e, "f_more", "f_ui_left2");
      },
    );
    var right2 = new ButtonInfo(
      "f_ui_right2",
      "right-angle2.png",
      "BUT_UI_RIGHT2",
      function (e) {
        addFree(e, "f_more", "f_ui_right2");
      },
    );
    var placeholder = new ButtonInfo(
      "f_ui_placeholder",
      "placeholder.png",
      "BUT_UI_PLACEHOLDER",
      function (e) {
        addFree(e, "f_placeholder");
      },
    );
    var tab = new ButtonInfo("f_ui_tab", "f_tab.png", "BUT_UI_TAB", function (
      e,
    ) {
      addFree(e, "f_tab");
    });
    var check_false = new ButtonInfo(
      "f_ui_check_false",
      "check_false.png",
      "BUT_UI_CHECK_FALSE",
      function (e) {
        addFree(e, "f_more", "f_ui_check_false");
      },
    );
    var check_true = new ButtonInfo(
      "f_ui_check_true",
      "check_true.png",
      "BUT_UI_CHECK_TRUE",
      function (e) {
        addFree(e, "f_more", "f_ui_check_true");
      },
    );
    var radio_false = new ButtonInfo(
      "f_ui_radio_false",
      "radio_false.png",
      "BUT_UI_RADIO_FALSE",
      function (e) {
        addFree(e, "f_more", "f_ui_radio_false");
      },
    );
    var radio_true = new ButtonInfo(
      "f_ui_radio_true",
      "radio_true.png",
      "BUT_UI_RADIO_TRUE",
      function (e) {
        addFree(e, "f_more", "f_ui_radio_true");
      },
    );
    var dots3h = new ButtonInfo(
      "f_ui_dots3h",
      "dots3h.png",
      "BUT_UI_DOTS3H",
      function (e) {
        addFree(e, "f_more", "f_ui_dots3h");
      },
    );
    var dots3v = new ButtonInfo(
      "f_ui_dots3v",
      "dots3v.png",
      "BUT_UI_DOTS3V",
      function (e) {
        addFree(e, "f_more", "f_ui_dots3v");
      },
    );
    var close = new ButtonInfo(
      "f_ui_close",
      "close.png",
      "BUT_UI_CLOSE",
      function (e) {
        addFree(e, "f_more", "f_ui_close");
      },
    );
    var close_mac = new ButtonInfo(
      "f_ui_close_mac",
      "close_mac.png",
      "BUT_UI_CLOSE_MAC",
      function (e) {
        addFree(e, "f_more", "f_ui_close_mac");
      },
    );
    var search = new ButtonInfo(
      "f_ui_search",
      "search.png",
      "BUT_UI_SEARCH",
      function (e) {
        addFree(e, "f_more", "f_ui_search");
      },
    );
    ...
    var pc = new ButtonInfo("f_ar_pc", "pc.png", "BUT_AR_PC", function (e) {
      addFree(e, "f_more", "f_ar_pc");
    });
    var human = new ButtonInfo(
      "f_ar_human",
      "human.png",
      "BUT_AR_HUMAN",
      function (e) {
        addFree(e, "f_more", "f_ar_human");
      },
    );
    var server1 = new ButtonInfo(
      "f_ar_server1",
      "server1.png",
      "BUT_AR_SERVER1",
      function (e) {
        addFree(e, "f_more", "f_ar_server1");
      },
    );
    var server2 = new ButtonInfo(
      "f_ar_server2",
      "server2.png",
      "BUT_AR_SERVER2",
      function (e) {
        addFree(e, "f_more", "f_ar_server2");
      },
    );
    var phone = new ButtonInfo(
      "f_ar_phone",
      "phone.png",
      "BUT_AR_PHONE",
      function (e) {
        addFree(e, "f_more", "f_ar_phone");
      },
    );
    var tablet = new ButtonInfo(
      "f_ar_tablet",
      "tablet.png",
      "BUT_AR_TABLET",
      function (e) {
        addFree(e, "f_more", "f_ar_tablet");
      },
    );
    var notebook = new ButtonInfo(
      "f_ar_notebook",
      "notebook.png",
      "BUT_AR_NOTEBOOK",
      function (e) {
        addFree(e, "f_more", "f_ar_notebook");
      },
    );
    var portrait = new ButtonInfo(
      "f_ar_portrait",
      "portrait.png",
      "BUT_AR_PORTRAIT",
      function (e) {
        addFree(e, "f_more", "f_ar_portrait");
      },
    );
    var cloud = new ButtonInfo(
      "f_cloud",
      "cloud.png",
      "BUT_AR_CLOUD",
      function (e) {
    ...
    var db = new ButtonInfo("f_db", "db.png", "BUT_AR_DATABASE", function (e) {
      addFree(e, "f_db", "");
    });
  ...
  function addSmallButton(div, id, text, tooltip, action) {
    ...
    if (tooltip) {
      globals.tooltip.make(button, tooltip);
    }
    if (action) {
  ...
  function applySearchOutput(options) {
    ...
    if (options.output.number) {
      ...
      if (options.output.total == 0) {
        HtmlUtils.setDivText(status, translate("MES_NOTHING_FOUND"));
        ...
        if (options.output.current == -1) {
          HtmlUtils.setDivText(
            status,
            translate("MES_FOUND") + " " + options.output.total,
          );
        } else {
          var current = options.output.current + 1;
          if (current > options.output.total) {
            HtmlUtils.setDivText(status, translate("MES_REACHED_END"));
          } else {
            HtmlUtils.setDivText(
              status,
              current +
                " " +
                translate("MES_FOUND_OF") +
                " " +
  ...
  function bText() {
    ...
    globals.inputBox.show(title, content, onSave, checkSource);
  }
  ...
  function centerItem(itemId) {
    if (itemId) {
      ...
      if (item) {
        ...
        globals.view.pan(-item.x + dx, -item.y + dy);
  ...
  function changeBackground(x, y) {
    ...
    var getColor = function () {
      var color = globals.background || Theme.get("back");
      return color;
    };
    ...
    if (isDrakon() || isMind()) {
      ...
      var getLineColor = function () {
        var color = globals.diaLine || Theme.getLine();
        return color;
      };
      ...
      var thickButt = createImageButton(
        ...
        30,
        function (data) {
          showThicknessItems(data, 1, globals.diaLineThickness || 1, setDLT);
        },
        false,
      );
    }
    var defaults = diaAddSection(null);
    diaAddButton(defaults, "MES_CLEAR_BACKGROUND", clearBackground);
    diaAddButton(defaults, "MES_SET_DEFAULT_BACK", setDefaultBackground);
    diaAddButton(defaults, "MES_CLEAR_DEFAULT_BACK", clearDefaultBackground);
    showDialog(x, y);
  }
  ...
  function changeFormat(x, y, ids) {
    ...
    if (format.lineOnly) {
      ...
      var getFillColor = function () {
        return dialogs.fillColor0 || Theme.getIconBack("action");
      };
      ...
      if (dialogs.allowSecondary) {
        ...
        var getSecondaryColor = function () {
          return dialogs.secondaryColor || Theme.getCommentBack();
        };
    ...
    var getTextColor = function () {
      return dialogs.textColor || Theme.getIconFont("action");
    };
    ...
    dialogs.boldButt = createFontButton(textDiv, "bold.png", onBoldClicked);
    ...
    dialogs.alignLeftButt.div.style.marginLeft = "5px";
    ...
    createCombo(text2, "MES_FONT_FAMILY", 150, families, onFamilyChanged);
    createCombo(
      text2,
      "MES_FONT_SIZE",
      50,
    ...
    createDialogButton(text3, "MES_SET_DEFAULT_FONT", setDefaultFont);
    var line = diaAddSection("MES_LINE");
    var lineDiv = make(line, "div");
    var getLineColor = function () {
      return dialogs.lineColor || Theme.getIconFont("action");
    };
    ...
    if (format.lineOnly) {
      ...
      createDialogButton(buttonsDiv, "MES_CLEAR_FORMAT", clearFormat);
      createDialogButton(buttonsDiv, "MES_SET_DEFAULT_STYLE", setDefaultStyle);
      createDialogButton(
        buttonsDiv,
    ...
    if (ids.length == 1) {
      var rect = globals.editor.getItemRect(ids[0]);
      var pos = diagramToClient(rect.right, rect.top);
      x = pos.x + 30;
      y = pos.y;
    }
    showDialog(x, y);
  ...
  function clearFormat() {
    ...
    globals.loadFont(false, false, family, file, finishClearFormat);
  }
  ...
  function createCheckHack(div, id, text, tooltip) {
    ...
    label.htmlFor = id;
    if (tooltip) {
      globals.tooltip.make(label, tooltip);
    }
    return checkbox;
  }

  function createCombo(parent, title, labelWidth, items, onClick) {
    var data = createButton(parent, showComboDropDown, false);
    data.title = title;
    data.items = items;
  ...
  function createDialogButton(parent, textId, onClick) {
    ...
    HtmlUtils.setDivText(div, globals.translate(textId));
  ...
  function createFontButton(parent, image, onClick) {
    return createImageButton(parent, image, 30, 30, onClick, true);
  }
  ...
  function createImageButton(parent, image, width, height, onClick, isToggle) {
    var data = createButton(parent, onClick, isToggle);
    var div = data.div;
    var img = make(div, "img");
    img.width = width;
    img.height = height;
  ...
  function createSideButton(button) {
    ...
    img.width = SideSize;
    img.height = SideSize;
    img.src = getImageForDirection(button, button.direction);
    var style = img.style;
    var radius = "7px";
  ...
  function debSchedule(self, action, timeout) {
    ...
    self.timer = setTimeout(callback, timeout);
  }
  ...
  function debounce(action, timeout) {
    ...
    debSchedule(globals.deb, action, timeout);
  }
  ...
  function destroySearchWindow() {
    if (globals.search) {
      document.body.removeChild(globals.search.root);
  ...
  function diaClear() {
    var dialogs = globals.dialogs;
    dialogs.dialog = HtmlUtils.createPopup(globals.beh.externalClick);
  ...
  function editLink(itemId, content, x, y) {
    ...
    diaAddButton(defaults, "MES_CLEAR", clearLink);
    var save = diaAddButton(defaults, "MES_SAVE", saveLink);
  ...
  function findFontsToLoad(component, value) {
    ...
    while (true) {
      ...
      pf[component] = value;
      var face2 = Utils.buildFontFace(pf.italic, pf.bold, pf.family);
      if (face2 in faceSet) {
      } else {
        faces2.push(face2);
      }
  ...
  function findIconGroup(name) {
    ...
    while (true) {
      if (_ind128 < _len128) {
        ...
        throw Error("Group '" + name + "' not found");
      }
  ...
  function finishClearFormat() {
    var dialogs = globals.dialogs;
    globals.editor.clearFormat(dialogs.ids);
    globals.view.redraw();
    hideDialog();
  }
  ...
  function getFonts(diagram) {
    var diagram2 = normalizeDiagram(diagram);
    ...
    while (true) {
      ...
      var parsed = Utils.parseFontString(font);
      var key =
        parsed.italic.toString() +
        "-" +
        parsed.bold.toString() +
        "-" +
        parsed.family;
      parsed.file = getFontFile(parsed.italic, parsed.bold, parsed.family);
      fonts[key] = parsed;
      _ind2235++;
    }
  ...
  function hasChanges() {
    if (
      globals.added.length == 0 &&
      globals.updated.length == 0 &&
      globals.removed.length == 0 &&
      !globals.changes
    ) {
      return false;
    } else {
  ...
  function init(cfg) {
    ...
    globals.root.oncontextmenu = function () {
      return false;
    };
    ...
    globals.back = back;
    HtmlUtils.setDivText(back, globals.translate("BUT_EXIT_4WAY_SCROLL"));
    ...
    globals.ro = ro;
    HtmlUtils.setDivText(ro, globals.translate("MES_READONLY_DOC"));
    ...
    createLeftButton(onToggleShowToolbar, "left", "#F2F2F2", "show-toobox.png");
    setupEditor();
    setupDialog();
  ...
  function layout() {
    ...
    setAbsRect(globals.root, left, top, width, height);
    layoutSideButtons();
    if (globals.freeScroll) {
      globals.back.style.display = "inline-block";
      hideDiv(globals.toolbar);
      setAbsRect(globals.canvas, 0, 0, width, height);
    } else {
      hideDiv(globals.back);
      if (globals.showToolbar) {
        setAbsRect(globals.toolbar, 0, 0, tbWidth, height);
        setAbsRect(globals.canvas, tbWidth + 1, 0, width - tbWidth - 1, height);
        setRect(globals.over, tbWidth + 1, 0, width - tbWidth - 1, height);
      } else {
        hideDiv(globals.toolbar);
        setAbsRect(globals.canvas, 0, 0, width, height);
        setRect(globals.over, 0, 0, width, height);
      }
    }
    //updateToolbar()
  }
  ...
  function layoutSideButtons() {
    ...
    if (globals.freeScroll) {
      ...
      while (true) {
        ...
        if (item.visible) {
          setAbsRect(item.div, left, top, SideSize, SideSize);
          top += SideSize;
        } else {
          hideDiv(item.div);
        }
      ...
      while (true) {
        ...
        if (item.visible) {
          setAbsRect(item.div, right, top, SideSize, SideSize);
          top += SideSize;
        } else {
          hideDiv(item.div);
        }
  ...
  function loadNextFont(self) {
    ...
    var pf = Utils.parseFontFace(face);
    var file = getFontFile(pf.italic, pf.bold, pf.family);
    var onLoaded = function () {
      self.fontLoaded();
    };
    globals.loadFont(pf.italic, pf.bold, pf.family, file, onLoaded);
  }
  ...
  function makeBoldFont(fontStr) {
    ...
    return Utils.buildFontString(font.italic, true, font.size, font.family);
  }
  ...
  function makeFontKey(italic, bold, family) {
    var key = family + "-" + italic.toString() + "-" + bold.toString();
    return key;
  }
  ...
  function makeRowUi(tr, row) {
    ...
    while (true) {
      ...
      globals.tooltip.make(img, ttext);
      _ind148++;
    }
  }
  ...
  function pan(dx, dy) {
    ...
    var zoom = globals.view.getZoom();
    globals.view.scrollBy(dx / zoom, dy / zoom);
  }
  ...
  function resize(left, top, width, height) {
    addTrace("ec:resize", [left, top, width, height]);
    globals.box = {
      left: left,
      top: top,
      width: width,
  ...
  function setAbsRect(div, left, top, width, height) {
    ...
    setRect(div, left, top, width, height);
  }
  ...
  function setBackgroundColor(color) {
    ...
    setDivColor(globals.dialogs.backColorButt, color);
    var fields = {
      background: color,
    };
    globals.editor.setBackground(fields);
  ...
  function setColorButColor(div, color) {
    if (color) {
      ...
      div.style.backgroundImage =
        "url('" + globals.imageBase + "no-color.png')";
  ...
  function setDefaultFont(color) {
    ...
    var font = Utils.buildFontString(italic, bold, size, family);
    var settings = {
      font: font,
    };
    globals.saveUserSettings(settings);
  ...
  function setDiaLineColor(color) {
    ...
    if (color) {
      setDivColor(globals.dialogs.diaLineColorButt, color);
    }
    var fields = {
      diaLine: color,
    };
  ...
  function setDialogPos(x, y) {
    var dialog = globals.dialogs.dialog;
    HtmlUtils.setPosCorrected(x, y, dialog);
    HtmlUtils.setUpMovable(dialog, 30);
  }

  function setDialogStyle(element) {
    element.style.border = "solid 1px #455A64";
    element.style.boxShadow = "0px 0px 5px rgba(0, 0, 0, 0.3)";
  ...
  function setFillColor(color) {
    ...
    setDivColor(dialogs.fillColorButt, color);
  ...
  function setFont(component) {
    ...
    var size = dialogs.size;
    var family = dialogs.family;
    addTrace("ec:setFont", [component, italic, bold, size, family]);
    var value = chooseFontComponent(component, italic, bold, size, family);
    if (component == "size") {
      finishSetFont(component, value);
    } else {
      var newFaces = findFontsToLoad(component, value);
  ...
  function setFormat(format) {
    ...
    var dialogs = globals.dialogs;
    globals.editor.setFormat(dialogs.ids, format);
    globals.view.redraw();
  }

  function setLeftButtonDirection(index, direction) {
    var buttInfo = globals.leftButts[index];
    buttInfo.div.src = getImageForDirection(buttInfo.button, direction);
  }
  ...
  function setLine(color, thickness) {
    ...
    dialogs.lineThickness = thickness;
    setDivColor(dialogs.lineColorButt, color);
    var lineColor;
    if (thickness == 1) {
      lineColor = color;
    } else {
      lineColor = "ct " + color + " " + thickness.toString();
    }
    var format = {
      lineColor: color,
    };
  ...
  function setLink(link) {
    ...
    if (link && !isGoodLink(link)) {
      ...
      globals.editor.setContent(dialogs.itemId, dialogs.content);
      globals.view.redraw();
    }
  }
  ...
  function setPos(element, x, y) {
    var pos = HtmlUtils.correctPosition(x, y, element);
    var style = element.style;
    style.left = pos.x + "px";
    style.top = pos.y + "px";
    return pos;
  ...
  function setSecondaryColor(color) {
    ...
    setDivColor(dialogs.secondaryColorButt, color);
    var fillColor;
    var format = {
  ...
  function setTextColor(color) {
    ...
    setDivColor(dialogs.textColorButt, color);
    var format = {
      textColor: color,
    };
    setFormat(format);
  ...
  function setUserSettings(settings) {
    ...
    globals.userColors = [];
    setNotNull(settings, "colors", globals, "userColors");
    setNotNull(settings, "shape", globals, "userShape");
    setNotNull(settings, "font", globals, "userFont");
    setNotNull(settings, "background", globals, "userBackground");
    setNotNull(settings, "diaLine", globals, "userDiaLine");
    setNotNull(settings, "diaLineThickness", globals, "userDiaLineThickness");
  }
  ...
  function setupEditor() {
    var view = new ViewWidget(window, document, globals.canvas, globals.over);
  ...
  function showArrowEndItems(data) {
    ...
    showDropDown(data.div, "MES_ARROW_HEAD", items, setArrowEnd);
  }
  ...
  function showArrowStartItems(data) {
    ...
    showDropDown(data.div, "MES_ARROW_TAIL", items, setArrowStart);
  }
  ...
  function showColorPicker(parent, color, titleId, onChange) {
    ...
    popup.style.boxShadow = "0px 0px 15px rgba(0, 0, 0, 0.6)";
    ...
    while (true) {
      ...
      var action = makeChooseSimple(onChange, rcolor);
    ...
    while (true) {
      ...
      while (true) {
        ...
        var b = addColorButton(row, cell, 1, makeChoosePalette(onChange, cell));
    ...
    var noop = function () {};
    var selColor = addColorButton(bottom, color, 5, noop);
    ...
    HtmlUtils.setDivText(apply, globals.translate("MES_APPLY"));
    apply.onclick = noop;
  ...
  function showContextMenu(x, y, menu) {
    ...
    globals.context(x, y, menu2, null, null);
  }
  ...
  function showDropDown(parent, title, rows, onItemClick) {
    ...
    header.colSpan = "2";
    HtmlUtils.setDivText(header, globals.translate(title));
    ...
    while (true) {
      ...
      textCell.onclick = makeItemClick(onItemClick, row);
      ...
      if (row.image) {
        ...
        HtmlUtils.setDivText(textCell, row.text);
  ...
  function showPopup(x, y) {
    ...
    HtmlUtils.setPosCorrected(x, y, popup);
  }
  ...
  function showStyleItems(data) {
    ...
    showDropDown(data.div, "MES_STYLE", items, setStyle);
  }
  ...
  function showThicknessItems(data, start, thickness, action) {
    ...
    showDropDown(data.div, "MES_THICKNESS", items, action);
  }
  ...
  function themeMatchesKey(theme, key) {
    ...
    while (true) {
      ...
      var key = _keys4215[_ind4215];
      var value = _col4215[key];
  ...
  function toggleSelectionMode(cell) {
    ...
    globals.tooltip.make(cell.img, globals.translate(tt));
  }
  ...
  function updateDiagram(fields) {
    ...
    while (true) {
      ...
      var name = _keys4147[_ind4147];
      var value = _col4147[name];
